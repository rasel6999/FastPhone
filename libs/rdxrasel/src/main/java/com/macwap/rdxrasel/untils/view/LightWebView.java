...
public class LightWebView extends WebView {
    ...
    public interface Listener {
        void onPageStarted(String url, @Nullable Bitmap favicon);
    ...
    public static OnScrollChangedCallback mOnScrollChangedCallback;

    public static final String TAG = LightWebView.class.getSimpleName();
    private int mLastMotionY;
    private final int[] mScrollOffset = new int[2];
    private final int[] mScrollConsumed = new int[2];
    private int mNestedYOffset;
    private NestedScrollingChildHelper mChildHelper;
     static String RDXERROR = "null";
    ...
    protected void init(Context context) {
        ...
        super.setWebViewClient(new WebViewClient() {
            ...
            public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
                ...
                RDXERROR=description;


                Log.d("testdescription",description);
    ...
    public static boolean handleDownload(final Context context, final String fromUrl, final String toFilename) {
        ...
        // if the download manager app has been disabled on the device
            ...
            openAppSettings(context, LightWebView.PACKAGE_NAME_DOWNLOAD_MANAGER);
...
///by rasel
    ...
    public static OnScrollChangedCallback getOnScrollChangedCallback()
    {
        return mOnScrollChangedCallback;
    }
    public static void setOnScrollChangedCallback(final OnScrollChangedCallback onScrollChangedCallback)
    {
