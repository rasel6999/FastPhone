...
class CustomizationActivity : BaseSimpleActivity() {
    ...
    private fun getAutoThemeColors(): MyTheme {
      ...
      //  put(THEME_BLACK_WHITE, MyTheme(R.string.black_white, android.R.color.white, android.R.color.black, android.R.color.black, R.color.md_grey_black))
        ...
        val textColor = if (isUsingSystemDarkTheme) android.R.color.white else R.color.theme_light_text_color
        val backgroundColor = if (isUsingSystemDarkTheme) android.R.color.black else R.color.dark_grey

              val val3 = if (isUsingSystemDarkTheme)  android.R.color.black else android.R.color.white
               val val4 = if (isUsingSystemDarkTheme)  R.color.md_grey_black else R.color.color_primary

               return MyTheme(R.string.auto_light_dark_theme, textColor, backgroundColor,val3, val4)
