    ...
    override fun onCreate(savedInstanceState: Bundle?) {
     /*   if (useDynamicTheme) {
        ...
        if(isUsingSystemDarkTheme){
            setTheme(R.style.AppTheme_BlackAndWhite)
            baseConfig.backgroundColor =
                ResourcesCompat.getColor(resources, android.R.color.black, theme)
            baseConfig.textColor = ResourcesCompat.getColor(resources, android.R.color.white, theme)
            baseConfig.primaryColor =
                ResourcesCompat.getColor(resources, android.R.color.black, theme)
            baseConfig.accentColor =
                ResourcesCompat.getColor(resources, R.color.color_primary, theme)
        }else {

            setTheme(R.style.AppTheme_White_LightTextColor)
            baseConfig.backgroundColor =
                ResourcesCompat.getColor(resources, android.R.color.white, theme)
            baseConfig.textColor = ResourcesCompat.getColor(resources, R.color.dark_grey, theme)
            baseConfig.primaryColor =
                ResourcesCompat.getColor(resources, android.R.color.white, theme)
            baseConfig.accentColor =
                ResourcesCompat.getColor(resources, R.color.color_primary, theme)
        }
        updateBackgroundColor(baseConfig.backgroundColor)
        getProperStatusBarColor()
        updateActionbarColor(baseConfig.primaryColor)
