    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (isDefaultDialer()) {
            ...
            if (!config.wasOverlaySnackbarConfirmed && !Settings.canDrawOverlays(this)) {
                val snackbar = Snackbar.make(main_coordinator, R.string.allow_displaying_over_other_apps, Snackbar.LENGTH_INDEFINITE).setAction(R.string.ok) {
    ...
    fun launchSetDefaultDialerIntent(activity: AppCompatActivity) {
        Intent(TelecomManager.ACTION_CHANGE_DEFAULT_DIALER).putExtra(
            ...
            if (resolveActivity(activity.packageManager) != null) {
                ...
                activity.toast(R.string.no_contacts_found)
            }
        }
    }
}
